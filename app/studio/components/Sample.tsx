...
// One gallery card — browser + phone previews plus meta. Shared by the
// mockup gallery below and the live client-work section.
export function SiteCard({ site: s }: { site: SampleSite }) {
  const { lang } = useLang();
  return (
    <article
